...
Su $I=[ -1,1]$ consideriamo un insieme di polinomi, detti \textbf{polinomi di Legendre}\index{polinomio!di Legendre}:
\begin{equation*}
...
Per $n\geqslant 0$, i \textbf{nodi di Gauss-Legendre}\index{nodi!di Gauss-Legendre} ed i relativi pesi sono dati da:
\begin{equation*}
...
\begin{figure}[ht]
	...
	\end{tikzpicture}
	\caption{La linea spessa denota la $f( x)$, la linea sottile continua denota l'approssimazione che si ottiene con la formula del trapezio, mentre la linea sottile tratteggiata denota l'approssimazione con Gauss-Lobatto.}
\end{figure}

La formula del trapezio integra in modo esatto fino a polinomi di grado $1$, mentre la \textbf{formula di Gauss-Lobatto}\index{formula!di Gauss-Lobatto} integra in modo esatto fino a grado $3$.
\begin{align*}
